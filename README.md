...
Teko is not a decentralized language like other languages like English rather it is a centralized language. Meaning, Teko's changes are recorded on the other hand other languages are changed overtime but no one knows how it changed or when it changed.
